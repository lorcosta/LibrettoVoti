...
public class Voto implements Comparable<Voto>{
	 ...
	 */
	public Voto(Voto v) {
		this.corso=v.corso;//v.getCorso()-->è una semplificazione di java che mi permette di accedere 
		this.voto=v.voto;//ai campi dell'oggetto dentro al quale sono
		this.data=v.data;
	}
	...
	/**
	 * crea una copia(clone) dell'oggetto parente (this), come nuovo oggetto
	 * @return Voto 
	 */
	public Voto clone() {
